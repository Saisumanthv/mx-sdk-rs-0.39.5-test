...
pub trait OngoingOperationModule {
    ...
    /// ```
    /// # use drt_sc::types::OperationCompletionStatus;
    /// # use drt_sc_modules::ongoing_operation::{
    /// #     self, CONTINUE_OP, DEFAULT_MIN_GAS_TO_SAVE_PROGRESS, STOP_OP,
    /// # };
    /// # pub trait ExampleContract: drt_sc::contract_base::ContractBase + ongoing_operation::OngoingOperationModule
    /// # {
