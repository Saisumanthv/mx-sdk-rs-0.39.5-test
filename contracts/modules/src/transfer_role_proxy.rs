use drt_sc::codec::TopEncodeMulti;
...
pub trait TransferRoleProxyModule {
    fn transfer_to_user(
        ...
        let contract_call =
            ContractCallWithMultiDcdt::<Self::Api, ()>::new(dest, data, payments.clone());
    ...
    fn transfer_to_contract_typed_call<T>(
        &self,
        original_caller: ManagedAddress,
        contract_call: ContractCallWithMultiDcdt<Self::Api, T>,
        ...
        T: TopEncodeMulti,
    {
        self.execute_async_call(
            original_caller,
            contract_call.dcdt_payments.clone(),
            contract_call,
            opt_custom_callback,
        );
    }
    ...
    fn transfer_to_contract_raw(
        ...
        let contract_call =
            ContractCallWithMultiDcdt::<Self::Api, ()>::new(dest, endpoint_name, payments.clone())
        ...
        T: TopEncodeMulti,
    {
        ...
        let cb_gas_needed =
            CALLBACK_RESERVED_GAS_PER_TOKEN * contract_call.dcdt_payments.len() as u64;
        require!(
    ...
    fn transfer_callback(
        &self,
        original_caller: ManagedAddress,
        initial_payments: ManagedVec<DcdtTokenPayment<Self::Api>>,
