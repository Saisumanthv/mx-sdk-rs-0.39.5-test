...
fn forw_raw_async_accept_rewa_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_async_accept_rewa.scen.json", world());
}

#[test]
fn forw_raw_async_accept_dcdt_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_async_accept_dcdt.scen.json", world());
}

#[test]
fn forw_raw_async_echo_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_async_echo.scen.json", world());
}
...
fn forw_raw_contract_deploy_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_contract_deploy.scen.json", world());
}

#[test]
fn forw_raw_contract_upgrade_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_contract_upgrade.scen.json", world());
}
...
fn forw_raw_direct_rewa_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_direct_rewa.scen.json", world());
}

#[test]
fn forw_raw_direct_dcdt_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_direct_dcdt.scen.json", world());
}

#[test]
fn forw_raw_direct_multi_dcdt_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_direct_multi_dcdt.scen.json", world());
}

#[test]
fn forw_raw_sync_echo_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_sync_echo.scen.json", world());
}

#[test]
fn forw_raw_sync_echo_caller_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_sync_echo_caller.scen.json", world());
}

#[test]
fn forw_raw_sync_rewa_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_sync_rewa.scen.json", world());
}

#[ignore]
#[test]
fn forw_raw_sync_readonly_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_sync_readonly.scen.json", world());
}

#[ignore]
#[test]
fn forw_raw_sync_same_context_rs() {
    drt_sc_scenario::run_rs("scenarios/forw_raw_sync_same_context.scen.json", world());
}
...
fn forwarder_builtin_nft_burn_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_builtin_nft_burn.scen.json", world());
}

#[test]
fn forwarder_builtin_nft_create_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_builtin_nft_create.scen.json", world());
}
...
fn forwarder_contract_deploy_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_contract_deploy.scen.json", world());
}

#[test]
fn forwarder_contract_upgrade_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_contract_upgrade.scen.json", world());
}
...
fn forwarder_get_dcdt_token_data_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_get_dcdt_token_data.scen.json", world());
}

#[test]
fn forwarder_nft_add_uri_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_nft_add_uri.scen.json", world());
}

#[test]
fn forwarder_nft_create_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_nft_create.scen.json", world());
}

#[test]
fn forwarder_nft_create_and_send_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_nft_create_and_send.scen.json", world());
}

#[test]
fn forwarder_nft_current_nonce_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_nft_current_nonce.scen.json", world());
}
...
fn forwarder_nft_transfer_async_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_nft_transfer_async.scen.json", world());
}

#[test]
fn forwarder_nft_transfer_exec_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_nft_transfer_exec.scen.json", world());
}
...
fn forwarder_no_endpoint_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_no_endpoint.scen.json", world());
}
...
fn forwarder_send_twice_rewa_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_send_twice_rewa.scen.json", world());
}

#[ignore]
#[test]
fn forwarder_send_twice_dcdt_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_send_twice_dcdt.scen.json", world());
}

#[test]
fn forwarder_sync_echo_rs() {
    drt_sc_scenario::run_rs("scenarios/forwarder_sync_echo.scen.json", world());
}
...
fn proxy_test_init_rs() {
    drt_sc_scenario::run_rs("scenarios/proxy_test_init.scen.json", world());
}

#[test]
fn proxy_test_message_othershard_rs() {
    drt_sc_scenario::run_rs("scenarios/proxy_test_message_otherShard.scen.json", world());
}
...
fn proxy_test_message_sameshard_rs() {
    drt_sc_scenario::run_rs("scenarios/proxy_test_message_sameShard.scen.json", world());
}
...
fn proxy_test_payment_othershard_rs() {
    drt_sc_scenario::run_rs("scenarios/proxy_test_payment_otherShard.scen.json", world());
}
...
fn proxy_test_payment_sameshard_rs() {
    drt_sc_scenario::run_rs("scenarios/proxy_test_payment_sameShard.scen.json", world());
}
...
fn proxy_test_upgrade_rs() {
    drt_sc_scenario::run_rs("scenarios/proxy_test_upgrade.scen.json", world());
}

#[test]
fn recursive_caller_rewa_1_rs() {
    drt_sc_scenario::run_rs("scenarios/recursive_caller_rewa_1.scen.json", world());
}

#[test]
fn recursive_caller_dcdt_1_rs() {
    drt_sc_scenario::run_rs("scenarios/recursive_caller_dcdt_1.scen.json", world());
}

#[test]
fn send_rewa_rs() {
    drt_sc_scenario::run_rs("scenarios/send_rewa.scen.json", world());
}

#[test]
fn send_dcdt_rs() {
    drt_sc_scenario::run_rs("scenarios/send_dcdt.scen.json", world());
}
