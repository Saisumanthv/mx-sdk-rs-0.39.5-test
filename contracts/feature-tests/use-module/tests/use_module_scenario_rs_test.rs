...
fn use_module_dns_register_rs() {
    drt_sc_scenario::run_rs("scenarios/use_module_dns_register.scen.json", world());
}

#[test]
fn use_module_features_rs() {
    drt_sc_scenario::run_rs("scenarios/use_module_features.scen.json", world());
}

#[test]
fn use_module_internal_rs() {
    drt_sc_scenario::run_rs("scenarios/use_module_internal.scen.json", world());
}

#[test]
fn use_module_only_owner_rs() {
    drt_sc_scenario::run_rs("scenarios/use_module_only_owner.scen.json", world());
}

#[test]
fn use_module_only_admin_rs() {
    drt_sc_scenario::run_rs("scenarios/use_module_only_admin.scen.json", world());
}

#[test]
fn use_module_no_endpoint_rs() {
    drt_sc_scenario::run_rs("scenarios/use_module_no_endpoint.scen.json", world());
}

#[test]
fn use_module_pause_rs() {
    drt_sc_scenario::run_rs("scenarios/use_module_pause.scen.json", world());
}
