use drt_sc::types::{Address, ManagedVec, MultiValueEncoded};
use drt_sc_modules::governance::{
    ...
    GovBuilder: 'static + Copy + Fn() -> use_module::ContractObj<DebugApi>,
{
    pub fn new(gov_builder: GovBuilder) -> Self {
        ...
        b_mock.set_dcdt_balance(&third_user, GOV_TOKEN_ID, &initial_gov);
...
fn change_gov_config_test() {
    ...
    gov_setup
        .b_mock
        .check_dcdt_balance(&first_user_addr, GOV_TOKEN_ID, &rust_biguint!(300));
    gov_setup
        .b_mock
        .check_dcdt_balance(&second_user_addr, GOV_TOKEN_ID, &rust_biguint!(1));
    gov_setup
        .b_mock
        .check_dcdt_balance(&third_user_addr, GOV_TOKEN_ID, &rust_biguint!(800));
    gov_setup
        .b_mock
        .check_dcdt_balance(&owner_addr, GOV_TOKEN_ID, &rust_biguint!(800));
}
...
fn down_veto_gov_config_test() {
    ...
    gov_setup
        .b_mock
        .check_dcdt_balance(&first_user_addr, GOV_TOKEN_ID, &rust_biguint!(200));
    gov_setup
        .b_mock
        .check_dcdt_balance(&second_user_addr, GOV_TOKEN_ID, &rust_biguint!(800));
    gov_setup
        .b_mock
        .check_dcdt_balance(&third_user_addr, GOV_TOKEN_ID, &rust_biguint!(800));
}
...
fn abstain_vote_gov_config_test() {
    ...
    gov_setup
        .b_mock
        .check_dcdt_balance(&first_user_addr, GOV_TOKEN_ID, &rust_biguint!(0));
    gov_setup
        .b_mock
        .check_dcdt_balance(&second_user_addr, GOV_TOKEN_ID, &rust_biguint!(600));
    gov_setup
        .b_mock
        .check_dcdt_balance(&third_user_addr, GOV_TOKEN_ID, &rust_biguint!(400));
}
