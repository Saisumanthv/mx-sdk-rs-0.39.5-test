...
use drt_sc_scenario::{managed_address, rust_biguint, testing_framework::*, DebugApi};

const MULTISIG_WASM_PATH: &str = "multisig/output/multisig.wasm";
const QUORUM_SIZE: usize = 1;
pub const REWA_TOKEN_ID: &[u8] = b"REWA";
                ...
                action_id = match action {
                    ...
                    ActionRaw::SendTransferExecute(call_data) => {
                        ...
                        sc.propose_transfer_execute(
                            ...
                            BigUint::from_bytes_be(&call_data.rewa_amount.to_bytes_be()),
                            opt_endpoint,
