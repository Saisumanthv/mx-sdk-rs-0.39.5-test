...
fn crowdfunding_claim_failed_rs() {
    drt_sc_scenario::run_rs("scenarios/crowdfunding-claim-failed.scen.json", world());
}

#[test]
fn crowdfunding_claim_successful_rs() {
    drt_sc_scenario::run_rs("scenarios/crowdfunding-claim-successful.scen.json", world());
}

#[test]
fn crowdfunding_claim_too_early_rs() {
    drt_sc_scenario::run_rs("scenarios/crowdfunding-claim-too-early.scen.json", world());
}

#[test]
fn crowdfunding_fund_rs() {
    drt_sc_scenario::run_rs("scenarios/crowdfunding-fund.scen.json", world());
}

#[test]
fn crowdfunding_fund_too_late_rs() {
    drt_sc_scenario::run_rs("scenarios/crowdfunding-fund-too-late.scen.json", world());
}

#[test]
fn crowdfunding_init_rs() {
    drt_sc_scenario::run_rs("scenarios/crowdfunding-init.scen.json", world());
}
...
fn rewa_crowdfunding_fund_rs() {
    drt_sc_scenario::run_rs("scenarios/rewa-crowdfunding-fund.scen.json", world());
}
...
fn rewa_crowdfunding_init_rs() {
    drt_sc_scenario::run_rs("scenarios/rewa-crowdfunding-init.scen.json", world());
}
