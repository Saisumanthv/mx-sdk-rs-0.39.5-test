use drt_price_aggregator_sc::{staking::StakingModule, PriceAggregator};
use drt_sc::types::{Address, RewaOrDcdtTokenIdentifier, MultiValueEncoded};
use drt_sc_modules::pause::PauseModule;
use drt_sc_scenario::{
...
pub static REWA_TICKER: &[u8] = b"REWA";
...
where
    PriceAggObjBuilder:
        'static + Copy + Fn() -> drt_price_aggregator_sc::ContractObj<DebugApi>,
{
    pub b_mock: BlockchainStateWrapper,
    pub owner: Address,
    pub oracles: Vec<Address>,
    pub price_agg: ContractObjWrapper<
        drt_price_aggregator_sc::ContractObj<DebugApi>,
        PriceAggObjBuilder,
    >,
}
