use crate::{address_h256_to_moars, denali_to_moars_address, Interactor, InteractorResult};
use log::info;
use drt_sc_scenario::{
    drt_sc::{
        codec::{multi_types::IgnoreValue, CodecFrom, TopEncodeMulti},
        types::ContractCallWithRewa,
    },
    scenario_model::{ScCallStep, TransferStep, TxCall, TypedScCall},
    DebugApi,
};
use drt_sdk::data::transaction::Transaction;

fn contract_call_to_tx_data(contract_call: &ContractCallWithRewa<DebugApi, ()>) -> String {
