    ...
    SA: StorageMapperApi + CallTypeApi,
{
    ...
    fn meta_issue(
        ...
        system_sc_proxy.register_meta_dcdt(
            issue_cost,
            &token_display_name,
            &token_ticker,
            properties,
    ...
    pub fn nft_create<T: TopEncode>(
        ...
        let token_nonce = send_wrapper.dcdt_nft_create_compact(&token_id, &amount, attributes);
    ...
    pub fn nft_add_quantity(&self, token_nonce: u64, amount: BigUint<SA>) -> DcdtTokenPayment<SA> {
        ...
        send_wrapper.dcdt_local_mint(&token_id, token_nonce, &amount);
