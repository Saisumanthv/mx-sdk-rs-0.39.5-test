...
impl SendApiImpl for VmApiImpl {
    ...
    fn transfer_dcdt_execute<M: ManagedTypeApi>(
        ...
        self.transfer_dcdt_nft_execute(to, token, 0, amount, gas_limit, endpoint_name, arg_buffer)
    }
    ...
    fn transfer_dcdt_nft_execute<M: ManagedTypeApi>(
        ...
        self.multi_transfer_dcdt_nft_execute(to, &payments, gas_limit, endpoint_name, arg_buffer)
    }
