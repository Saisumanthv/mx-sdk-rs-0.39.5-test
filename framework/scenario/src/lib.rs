...
pub use drt_chain_vm::{
    self, bech32, drt_sc, num_bigint, scenario_format, ContractInfo, DebugApi,
};

/// Exposing the scenario model. Might be moved in the future,
/// but the export will hopefully remain the same.
pub use drt_chain_vm::scenario::model as scenario_model;

/// For backwards compatibility, will be removed.
pub use drt_chain_vm::scenario as denali_system;
