use crate::{drt_chain_vm::scenario::executor::parse_execute_denali_steps, ScenarioWorld};
use std::path::Path;
...
pub fn run_rs<P: AsRef<Path>>(relative_path: P, mut world: ScenarioWorld) {
    ...
    parse_execute_denali_steps(absolute_path.as_ref(), &mut world.blockchain_mock);
}
