...
#[test]
fn transfer_rewa_rs() {
    drt_sc_scenario::run_rs("tests/scenarios-self/transfer-rewa.scen.json", world());
}

#[test]
fn transfer_dcdt_rs() {
    drt_sc_scenario::run_rs("tests/scenarios-self/transfer-dcdt.scen.json", world());
}

#[test]
fn validator_reward_rs() {
    drt_sc_scenario::run_rs("tests/scenarios-self/validatorReward.scen.json", world());
}
