...
use drt_sc_codec as codec;
use drt_sc_codec_derive::*;
...
// i.e. any types that are in scope and happen to have the same name as drt-sc-codec types do not break the build.
...
// Also adding all public functions exposed by drt-sc-codec.
