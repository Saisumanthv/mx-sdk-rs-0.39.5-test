...
# We always publish `drt-codec` and `drt-codec-derive` together.
# `framework/*` depend on both `drt-codec` and `drt-chain-scenario-format`,
...
#
# 10. Go to https://github.com/dharitri/drt-sdk-rs/tags
