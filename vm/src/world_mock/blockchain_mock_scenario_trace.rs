...
impl BlockchainMock {
    pub fn write_scenario_trace<P: AsRef<Path>>(&mut self, file_path: P) {
        ...
        let denali_trace = core::mem::take(&mut self.scenario_trace);
...
fn addr_key_to_pretty(
    ...
    match addr_to_denali_string_map.get(&addr_key.value) {
...
fn addr_value_to_pretty(
    ...
    match addr_to_denali_string_map.get(&addr_val.value) {
