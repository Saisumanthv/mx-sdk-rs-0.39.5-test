...
use drt_sc::{
    ...
    err_msg,
    types::{
        heap::Address, ArgBuffer, BigUint, BoxedBytes, CodeMetadata, DcdtTokenPayment,
...
impl DebugApi {
    ...
    fn prepare_execute_on_dest_context_input(
        ...
        let async_call_data = self.create_async_call_data(to, rewa_value, func_name, args);
    ...
    fn perform_execute_on_dest_context(
        ...
        let tx_input = self.prepare_execute_on_dest_context_input(to, rewa_value, func_name, args);
...
impl SendApiImpl for DebugApi {
    ...
    fn transfer_dcdt_execute<M: ManagedTypeApi>(
        &self,
        to: &ManagedAddress<M>,
    ...
    fn transfer_dcdt_nft_execute<M: ManagedTypeApi>(
        &self,
        to: &ManagedAddress<M>,
        token: &TokenIdentifier<M>,
        nonce: u64,
        ...
        let _ = self.perform_transfer_execute(
            contract_address,
            num_bigint::BigUint::zero(),
            DCDT_NFT_TRANSFER_FUNC_NAME.into(),
            args,
        );
    ...
    fn multi_transfer_dcdt_nft_execute<M: ManagedTypeApi>(
        &self,
        to: &ManagedAddress<M>,
        ...
        let _ = self.perform_transfer_execute(
            contract_address,
            num_bigint::BigUint::zero(),
            DCDT_MULTI_TRANSFER_FUNC_NAME.into(),
            args,
        );
    ...
    fn transfer_dcdt_execute_legacy<M: ManagedTypeApi>(
        &self,
        _to: &Address,
    ...
    fn transfer_dcdt_nft_execute_legacy<M: ManagedTypeApi>(
        &self,
        _to: &Address,
        _token: &TokenIdentifier<M>,
        _nonce: u64,
    ...
    fn multi_transfer_dcdt_nft_execute_legacy<M: ManagedTypeApi>(
        &self,
        _to: &Address,
        _payments: &[DcdtTokenPayment<M>],
        _gas_limit: u64,
        _endpoint_name: &BoxedBytes,
        _arg_buffer: &ArgBuffer,
    ) -> Result<(), &'static [u8]> {
